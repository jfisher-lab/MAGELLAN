...
def test_check_pert_dic_values():
    ...
    valid_dic = {
        "node1": {"pert": {"param1": 0.5, "param2": 0.3}},
        "node2": {"pert": {"param1": 0.7, "param2": 0.2}},
    }
    ...
    invalid_low = {"node1": {"pert": {"param1": -0.1, "param2": 0.3}}}
    ...
    invalid_high = {"node1": {"pert": {"param1": 1.2, "param2": 0.3}}}
    ...
    custom_bounds = {"node1": {"pert": {"param1": 2.5, "param2": 3.0}}}
