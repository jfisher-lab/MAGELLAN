...
def sample_data():
    ...
    y = pd.DataFrame(
        {"exp1": [1.0, 2.0, 3.0], "exp2": [2.0, 3.0, 4.0], "exp3": [3.0, 4.0, 5.0]},
        index=["gene1", "gene2", "gene3"],
    )

    pred = pd.DataFrame(
        {"exp1": [1.1, 2.2, 2.8], "exp2": [1.9, 3.1, 4.2], "exp3": [3.2, 3.8, 4.9]},
        index=["gene1", "gene2", "gene3"],
    )
...
def test_basic_error_calculation(sample_data):
    ...
    expected_rmse = np.array(
        [
            np.sqrt(
                ((1.1 - 1.0) ** 2 + (1.9 - 2.0) ** 2 + (3.2 - 3.0) ** 2) / 3
            ),  # gene1
            np.sqrt(
                ((2.2 - 2.0) ** 2 + (3.1 - 3.0) ** 2 + (3.8 - 4.0) ** 2) / 3
            ),  # gene2
            np.sqrt(
                ((2.8 - 3.0) ** 2 + (4.2 - 4.0) ** 2 + (4.9 - 5.0) ** 2) / 3
            ),  # gene3
        ]
    )
...
def test_subset_indices():
    ...
    y = pd.DataFrame(
        {"exp1": [1.0, 2.0, 3.0], "exp2": [2.0, 3.0, 4.0]},
        index=["gene1", "gene2", "gene3"],
    )
...
def test_perfect_prediction():
    ...
    y = pd.DataFrame({"exp1": [1.0, 2.0], "exp2": [3.0, 4.0]}, index=["gene1", "gene2"])
